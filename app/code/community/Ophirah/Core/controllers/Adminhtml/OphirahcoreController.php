...
class Ophirah_Core_Adminhtml_OphirahcoreController extends Mage_Adminhtml_Controller_Action
{
    ...
    const IONCUBE_461_PHP_53 = 'ic_loader_4.6.1_php_5.3';
    const IONCUBE_461_PHP_55 = 'ic_loader_4.6.1_php_5.5';
    const IONCUBE_500_PHP_56 = 'ic_loader_4.7.0_php_5.6';
    ...
    public function installAction()
    {
        ...
        if (($this->versionModel->getInstallType() == Ophirah_Core_Model_Version::INSTALL_TYPE_EC)
            ...
            $warning = $this->__('IonCube is not installed, instalation aborted.');
        ...
        try {
            ...
            if ($compressed) {
                ...
                Mage::log('Install (unpack): fail', null, 'c2q_install.log', true);
                $warning = $this->__('Unpack failed, instalation aborted.');
                Mage::getSingleton('adminhtml/session')->addWarning($warning);
                $this->_redirectReferer();
            }
        } catch (Exception $e) {
            ...
            $warning = $this->__('Unpack error, instalation aborted.');
            Mage::getSingleton('adminhtml/session')->addWarning($warning);
            $this->_redirectReferer();
        }
        ...
        try {
            ...
            //report error
            $error = $this->__('Instalation aborted.');
