...
/**
 * Class Ophirah_Fakepro_Model_Pdf_Product
 */
class Ophirah_Fakepro_Model_Pdf_Product extends Ophirah_Qquoteadv_Model_Pdf_Qquote
{
    protected $_helper;
    ...
    /**
     * Draws a specific render for a fake product.
     *
     * @param $unit (product)
     * @param $page
     * @return mixed
    ...
    public function draw($unit, $page)
    {
        ...
        Mage::helper('fakepro')->setCurrentCurrency($currentCurrencyCode, $_quote->getStoreId());
    ...
    /**
     * Retrieves fake pro helper.
     * @return Ophirah_Fakepro_Helper_Data
     * @since 1.0.5
     */
    protected function getHelper(){
        if(!$this->_helper){
            $this->_helper = Mage::helper('fakepro');
        }
        return $this->_helper;
    }
