...
class Ophirah_Fakepro_Adminhtml_FakeproController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function addAction() {
        ...
        Mage::dispatchEvent('fakepro_adminhtml_before_add', array('quote_id' => $c2qId));

        $allowed = Mage::helper('qquoteadv/licensechecks')->isAllowedFakeProduct();
        if(!$allowed){
            $errorMsg = $this->__("This function is only available in the Cart2Quote enterprise edition. <a href='https://www.cart2quote.com/cart2quote-update-upgrade.html'>Upgrade</a>");
        ...
        Mage::dispatchEvent('fakepro_adminhtml_after_add', array('quote_id' => $c2qId));
        return;
    }
